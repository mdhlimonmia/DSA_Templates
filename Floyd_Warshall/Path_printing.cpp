...
/*Find shortest path of all pairs*/
...
void solve() {
    ...
    /*print shortest distance of all pairs.*/
    for (int i = 1; i <= n; i++) {
        for (int j = 1; j <= n; j++) {
    ...
    /* Shortest path printing for give sourch and destination */
    ll q; cin>>q;
    while(q--){
        int s, d; cin>>s>>d;
